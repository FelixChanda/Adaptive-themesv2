...
// Release signing is loaded from keystore.properties (git-ignored, never committed)
// or from environment variables so CI can inject secrets without a file on disk.
...
android {
    ...
    buildTypes {
        release {
            ...
            // NOTE: if no keystore.properties / env vars are present, this build type is
            // intentionally left unsigned so CI without secrets (e.g. PR builds) doesn't fail.
            // It will NOT produce an installable/deployable APK until signed.
        }
        debug {
